...
public class VideoRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<SeasonQueryBean.DataBean.ResultsBean> dataList = new ArrayList<>();
    ...
    public VideoRecyclerViewAdapter(Context mContext, List<SeasonQueryBean.DataBean.ResultsBean> list) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        SeasonQueryBean.DataBean.ResultsBean t = dataList.get(position);
        viewHolder.mTextView.setText(t.getTitle());
        ...
        Glide.with(mContext).load(t.getUrl()).centerCrop().into(viewHolder.imageView);
