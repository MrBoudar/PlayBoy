...
import com.example.mrboudar.playboy.common.ATStringTool;
import com.example.mrboudar.playboy.progressindicator.AVLoadingIndicatorView;
        ...
        switch (state) {
            ...
            case STATE_CLICK_LOAD:
                if (isLoadMoreClickStyle) {
                    mText.setText(ATStringTool.concatString(clickLoadDesc, getResources().getString(R.string.click_more_flag)));
                } else {
                    mText.setText(getResources().getString(R.string.nomore_loading));
                }
                progressCon.setVisibility(View.GONE);
